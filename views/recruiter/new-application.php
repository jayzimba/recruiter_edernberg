    ...
    document.addEventListener('DOMContentLoaded', function() {
                                ...
                                programSelect.addEventListener('change', function() {
                                    ...
                                    if (selectedProgramId) {
                                        ...
                                        if (studyModeId) {
                                            ...
                                            // Instead of disabling the select, make it readonly using a hidden input
                                            studyModeSelect.setAttribute('readonly', true);
                                        ...
                                        studyModeSelect.removeAttribute('readonly');
        ...
        document.getElementById('applicationForm').addEventListener('submit', function(e) {
            e.preventDefault();
                ...
                // If study mode is readonly, ensure we're using the hidden input value
                const studyModeSelect = document.getElementById('study_mode_id');
                if (studyModeSelect.hasAttribute('readonly')) {
                    const hiddenValue = document.getElementById('hidden_study_mode').value;
                    formData.set('study_mode_id', hiddenValue);
                }
